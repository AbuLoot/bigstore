<?php require VIEW_ROOT . '/admin/templates/header.php'; ?>
      ...
      <form action="<?= BASE_URL ?>/admin/categories/edit.php" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="sort_id" id="sort_id" value="<?= $category['sort_id'] ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="meta_description" id="meta_description" value="<?= $category['meta_description'] ?>">
        </div>
        <div class="form-group">
