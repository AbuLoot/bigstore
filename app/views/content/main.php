<?php require VIEW_ROOT . '/templates/header.php'; ?>
      ...
      <div class="row">
        <div class="col-md-9">
          <h3><span class="glyphicon glyphicon-fire"></span> Hot</h3>
        </div>
        <div class="col-md-3">
                    ...
                    <div class="thumbnail">
                      ...
                      <div class="caption">
                        ...
                        <div class="btn-group btn-group-justified">
                          ...
                          <a href="#" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-shopping-cart"></span> Buy</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="item <?php if ($key == 0) echo 'active'; ?>">
              <div class="row">
                <?php foreach ($new_products as $new_product) : ?>
                  <div class="col-sm-6 col-md-3">
                    <div class="thumbnail">
                      <a href="<?= BASE_URL . '/product.php?category_id=' . $new_product['category_id'] . '&id=' . $new_product['id'] ?>"><img src="<?= BASE_URL . '/uploads/' . $new_product['path'] . '/' . $new_product['image'] ?>" alt="..."></a>
                      <div class="caption">
                        <h4><a href="<?= BASE_URL . '/product.php?category_id=' . $new_product['category_id'] . '&id=' . $new_product['id'] ?>"><?= $new_product['title'] ?></a></h4>
                        <div class="btn-group btn-group-justified">
