<?php require VIEW_ROOT . '/templates/header.php'; ?>
      ...
      <ol class="breadcrumb">
        <li><a href="<?= BASE_URL ?>"><span class="glyphicon glyphicon-home"></span> Main</a></li>
      ...
      <div class="row">
        <div class="col-md-6">
          <div id="carousel-product" class="carousel" data-ride="carousel" data-interval="false">
          ...
          <ol class="list-inline">
            <?php foreach ($images as $key => $image) : ?>
              <li data-target="#carousel-product" data-slide-to="<?= $key ?>" class="col-md-2 <?php if ($key == 0) echo 'active'; ?>">
        ...
        <div class="col-md-6">
          ...
          <p><a href="#" class="btn btn-primary"><span class="glyphicon glyphicon-shopping-cart"></span> Buy</a></p>
        </div>
        <div class="col-md-12">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#description" aria-controls="description" data-toggle="tab">Description</a></li>
            <li><a href="#characteristic" aria-controls="characteristic" data-toggle="tab">Characteristic</a></li>
            <li><a href="#comments" aria-controls="comments" data-toggle="tab">Comments</a></li>
          </ul>
          <br>
